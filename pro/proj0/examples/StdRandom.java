...
public final class StdRandom {
    ...
    public static void main(String[] args) {
        ...
        out.println("seed = " + StdRandom.getSeed());
        for (int i = 0; i < n; i++) {
            out.printf("%2d "  , uniform(100));
            out.printf("%8.5f ", uniform(10.0, 99.0));
            out.printf("%5b "  , bernoulli(0.5));
            out.printf("%7.5f ", gaussian(9.0, 0.2));
            out.printf("%1d "  , discrete(probabilities));
            out.printf("%1d "  , discrete(frequencies));
            StdRandom.shuffle(a);
            for (String s : a)
                out.print(s);
            out.println();
